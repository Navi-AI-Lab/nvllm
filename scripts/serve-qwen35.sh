...
# CuTe is the production decode path; scripts/serve-qwen35-triton.sh is the
# upstream-only fallback (no CuTe kernels, triton_attn).
#
...
#
# Usage:
#   ./scripts/serve-qwen35.sh          # Standard launch
#   ./scripts/serve-qwen35.sh --debug  # Eager mode, no CUDA graphs
