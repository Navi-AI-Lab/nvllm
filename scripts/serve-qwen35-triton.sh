...
#
# Usage:
#   ./scripts/serve-qwen35-triton.sh          # Standard launch (FP8 KV)
#   ./scripts/serve-qwen35-triton.sh --tq     # TurboQuant KV cache (more context)
#   ./scripts/serve-qwen35-triton.sh --debug  # Eager mode, no CUDA graphs
