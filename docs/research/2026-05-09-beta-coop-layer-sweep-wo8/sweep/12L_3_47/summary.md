...
- description: β-coop on first 12 full-attn layers
...
- arms.csv row: arm=12L_3_47, fusion=1, phase_e_layers=[3,7,11,15,19,23,27,31,35,39,43,47],
  wo_split=8, expected_coop_layers=[3,7,11,15,19,23,27,31,35,39,43,47]

## Dispatch audit
- result: PASS (coop_layers matched expected=[3,7,11,15,19,23,27,31,35,39,43,47])
