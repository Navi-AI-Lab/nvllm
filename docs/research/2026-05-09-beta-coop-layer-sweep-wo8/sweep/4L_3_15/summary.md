...
- description: β-coop on first 4 full-attn layers
...
- arms.csv row: arm=4L_3_15, fusion=1, phase_e_layers=[3,7,11,15],
  wo_split=8, expected_coop_layers=[3,7,11,15]

## Dispatch audit
- result: PASS (coop_layers matched expected=[3,7,11,15])
