#!/usr/bin/env bash
# Run the attention PTX-diff harness inside a given nvllm image and
# capture the emitted IR/PTX/CUBIN plus an env snapshot.
#
# Usage: run_diagnostic.sh <image:tag> <host_output_dir>
# Example:
#   run_diagnostic.sh nvllm:gb10-phaseD2e /tmp/attn_ptx_dump_d2e
...
HARNESS="${REPO_ROOT}/docs/research/phase_a_attn_ptx_diag/harness.py"
