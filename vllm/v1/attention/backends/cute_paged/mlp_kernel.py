...
# Tile-preset registry lives in the sibling `_tile_presets.py` module
# (single source of truth). The previous duplicate registry / resolver
# stub here was D3a-era audit-trail debris and is removed 2026-04-25.
from vllm.v1.attention.backends.cute_paged._tile_presets import (  # noqa: E402
